              ...
              <tbody>
                {result.subjects.slice(0, 3).map((subject, idx) => (
                  <tr key={idx} className="hover:bg-[#f5e1e8] print:hover:bg-transparent">
                    ...
                    <td className="border-2 border-[#e0c5d1] px-4 py-2 text-gray-800 print:border print:border-[#c4528b] print:px-3 print:py-1 print:text-sm">{subject.theory}</td>
                    <td className="border-2 border-[#e0c5d1] px-4 py-2 text-gray-800 print:border print:border-[#c4528b] print:px-3 print:py-1 print:text-sm">{subject.practical}</td>
                    <td className="border-2 border-[#e0c5d1] px-4 py-2 text-gray-800 font-bold print:border print:border-[#c4528b] print:px-3 print:py-1 print:text-sm print:font-bold">{subject.total}</td>
                    <td className="border-2 border-[#e0c5d1] px-4 py-2 text-gray-800 font-bold print:border print:border-[#c4528b] print:px-3 print:py-1 print:text-sm print:font-bold">{subject.grade}</td>
                  </tr>
                ))}
              </tbody>
            </table>
